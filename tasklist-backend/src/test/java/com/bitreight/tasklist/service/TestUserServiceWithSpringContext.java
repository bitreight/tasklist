...
@Ignore
public class TestUserServiceWithSpringContext {
    ...
    @Test
    public void testRegister() throws DaoSaveDuplicatedUserException {
        try {
    ...
    @Test
    public void testRegister_nullUserDto() throws DaoSaveDuplicatedUserException {
        try {
